    ...
    <footer className="bg-[#171D22] text-white py-10 px-6 md:px-10 lg:px-20">
      <div className="flex flex-col md:flex-row justify-between items-center w-full">
        ...
        <div className="flex space-x-4">
          <a href="https://twitter.com" target="_blank" className="hover:text-[#E2D609]">
            <FontAwesomeIcon icon={faTwitter} size="lg" />
          </a>

          <a href="https://facebook.com" target="_blank" className="hover:text-[#E2D609]">
            <FontAwesomeIcon icon={faFacebook} size="lg" />
          </a>

          <a href="https://instagram.com" target="_blank" className="hover:text-[#E2D609]">
